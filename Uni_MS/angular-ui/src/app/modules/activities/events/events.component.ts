...
@Component({
  ...
  template: `
    ...
    <div class="page-header">
      <div>
        <h2>Events</h2>
        <p class="page-sub">Manage campus events and activities</p>
      </div>
...
export class EventsComponent implements OnInit {
  ...
  columns: TableColumn[] = [
    ...
    { key: 'title', label: 'Title', sortable: true, type: 'text', required: true, placeholder: 'Enter event title' },
    { key: 'eventType', label: 'Type', sortable: true, type: 'text', required: true, placeholder: 'Workshop/Seminar' },
    { key: 'startDate', label: 'Start Date', type: 'date', required: true },
    { key: 'endDate', label: 'End Date', type: 'date', required: true },
    { key: 'venue', label: 'Venue', type: 'text', placeholder: 'Event venue' },
    { key: 'clubId', label: 'Club ID', type: 'number', placeholder: 'Club ID' }
  ];
  ...
  constructor(private service: EventService, private toastService: ToastService) {}
