...
import { AdmissionRequirementService } from '../../../services/admission-requirement.service';
...
export class AdmissionRequirementsComponent implements OnInit {
  ...
  constructor(private service: AdmissionRequirementService, private toastService: ToastService) {}
