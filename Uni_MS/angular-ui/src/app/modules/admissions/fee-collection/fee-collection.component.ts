...
import { AdmissionFeeCollectionService } from '../../../services/admission-fee-collection.service';
...
export class FeeCollectionComponent implements OnInit {
  ...
  constructor(private service: AdmissionFeeCollectionService, private toastService: ToastService) {}
  ...
  saveItem(data: any) {
    ...
    else { this.service.save(data).subscribe({ next: () => ok('Payment recorded'), error: err }); }
  }
