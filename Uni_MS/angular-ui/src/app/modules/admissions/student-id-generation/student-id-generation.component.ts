...
import { StudentIdGenerationService } from '../../../services/student-id-generation.service';
...
export class StudentIdGenerationComponent implements OnInit {
  ...
  constructor(private service: StudentIdGenerationService, private toastService: ToastService) {}
  ...
  saveItem(data: any) {
    ...
    else { this.service.save(data).subscribe({ next: () => ok('ID generated'), error: err }); }
  }
