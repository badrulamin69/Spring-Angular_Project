...
@Component({
  ...
  template: `
    ...
    <div class="page-header">
      <div>
        <h2>Invoices</h2>
        <p class="page-sub">Manage invoices and payments</p>
      </div>
...
export class InvoicesComponent implements OnInit {
  ...
  columns: TableColumn[] = [
    ...
    { key: 'totalAmount', label: 'Amount', sortable: true, type: 'number', required: true, placeholder: '5000.00' },
  ...
  saveItem(data: any) {
    ...
    if (this.editingItem?.id) {
      ...
      this.service.save(data).subscribe({
        next: () => handleSuccess('Invoice created successfully'),
        error: handleError
      });
    }
  }
