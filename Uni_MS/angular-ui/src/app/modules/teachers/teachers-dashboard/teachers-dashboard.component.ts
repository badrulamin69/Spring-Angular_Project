...
@Component({
  ...
  styles: [`
    ...
    .loader { width: 36px; height: 36px; border: 3px solid var(--border-color); border-top-color: var(--brand-color, #0d9488); border-radius: 50%; animation: spin 0.8s linear infinite; }
    ...
    .quick-link:hover { border-color: var(--brand-color, #0d9488); color: var(--brand-color, #0d9488); background: var(--bg-secondary); }
