...
export class CertificateService {
  ...
  findAll(params: PageParams = DEFAULT_PAGE_PARAMS, search: string = ''): Observable<PagedResponse<Certificate>> {
    ...
    return this.http.get<PagedResponse<Certificate>>(this.apiUrl, { params: httpParams });
  }
