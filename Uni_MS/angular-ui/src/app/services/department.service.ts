...
export class DepartmentService {
  ...
  findAll(params: PageParams = DEFAULT_PAGE_PARAMS, search: string = ''): Observable<PagedResponse<Department>> {
  ...
  findByFaculty(facultyId: number, size: number = 200): Observable<any[]> {
