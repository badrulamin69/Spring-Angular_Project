...
public class EnrollmentController {
    ...
    public ResponseEntity<Map<String, Object>> enrollFromAllocation(@PathVariable Long allocationId) {
        return ResponseEntity.ok(enrollmentService.enrollFromAllocation(allocationId));
    }
