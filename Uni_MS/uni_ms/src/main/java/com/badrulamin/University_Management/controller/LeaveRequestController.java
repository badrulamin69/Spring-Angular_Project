...
public class LeaveRequestController {
    ...
    @GetMapping
    public ResponseEntity<PagedResponse<LeaveRequest>> findAll(
    ...
    @PostMapping
    public ResponseEntity<LeaveRequest> save(@Valid @RequestBody LeaveRequest leaveRequest) {
        return ResponseEntity.ok(leaveRequestService.save(leaveRequest));
    }

    @PreAuthorize("hasAuthority('LEAVE_APPROVE')")
    @PutMapping("/{id}")
    public ResponseEntity<LeaveRequest> update(@PathVariable Long id, @Valid @RequestBody LeaveRequest leaveRequest) {
        return ResponseEntity.ok(leaveRequestService.update(id, leaveRequest));
    }
